...
public class JsonObjectRequestUtil extends JsonObjectRequest {
    ...
    public JsonObjectRequestUtil(int  method, String  url, JSONObject jsonRequest, Response.Listener<JSONObject> listener, Response.ErrorListener errorListener, String authorization) {
